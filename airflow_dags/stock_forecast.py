...
args = {
    ...
    "start_date": dt.datetime(2023, 11, 25),  # Начальная дата выполнения DAG
...
with DAG(dag_id='stock_forecast', default_args=args, schedule=None, tags=['stock', 'DJIA']) as dag:
    ...
    get_data = BashOperator(task_id='get_data',
        bash_command='python3 /home/airflow/project/scripts/get_data.py',
        dag=dag)

    # Задача для подготовки данных (Запускает скрипт Python preprocess_data.py)
    prepare_data = BashOperator(task_id='prepare_data',
        bash_command='python3 /home/airflow/project/scripts/process_data.py',
        dag=dag)
    ...
    train_test_split = BashOperator(task_id='train_test_split',
        bash_command='python3 /home/airflow/project/scripts/train_test_split.py',
        dag=dag)
    ...
    train_model = BashOperator(task_id='train_model',
        bash_command='python3 /home/airflow/project/scripts/train_model.py',
        dag=dag)
    ...
    test_model = BashOperator(task_id='test_model',
        bash_command='python3 /home/airflow/project/scripts/test_model.py',
        dag=dag)
